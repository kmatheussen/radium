...
BUILDTYPE=DEBUG ./build_linux.sh -j7 && LD_LIBRARY_PATH=$LD_LIBRARY_PATH G_DEBUG=fatal-criticals gdb bin/radium_linux.bin # QT_FATAL_WARNINGS=1 causes lots of crashes in qt5
