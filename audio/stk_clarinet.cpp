...
class Clarinet_dsp : public dsp {
	  ...
	  public:
		...
		void fill (int count, float output[]) {
			for (int i=0; i<count; i++) {
				iRec3[0] = (1 + iRec3[1]);
				output[i] = sinf((9.587379924285257e-05f * float((iRec3[0] - 1))));
				// post processing
				iRec3[1] = iRec3[0];
			}
		}
  ...
  public:
	...
	virtual void buildUserInterface(UI* interface) {
		interface->openVerticalBox("clarinet");
		...
		interface->declare(&fslider9, "tooltip", "Envelope decay duration");
		interface->declare(&fslider9, "unit", "s");
		interface->addHorizontalSlider("Envelope_Decay", &fslider9, 0.05f, 0.0f, 2.0f, 0.01f);
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow1 = (0.0010000000000000009f * fslider0);
		...
		float 	fSlow15 = (6 * (fSlow13 * (fSlow2 < 2)));
		float 	fSlow16 = (fConst2 / fSlow4);
		int 	iSlow17 = int((fSlow16 - (1.5f + fSlow15)));
		int 	iSlow18 = int((1 + int((iSlow17 & 4095))));
		float 	fSlow19 = (fSlow15 + iSlow17);
		float 	fSlow20 = ((fSlow19 + 2.5f) - fSlow16);
		int 	iSlow21 = int((1 + int((int((1 + iSlow17)) & 4095))));
		float 	fSlow22 = (fSlow16 - (1.5f + fSlow19));
		int 	iSlow23 = (fSlow2 >= 3);
		float 	fSlow24 = (3.141592653589793f * (fSlow2 == 2));
		float 	fSlow25 = (3.141592653589793f * (fSlow2 == 0));
		float 	fSlow26 = (1.5707963267948966f * (fSlow2 == 1));
		int 	iSlow27 = (fSlow2 < 3);
		float 	fSlow28 = (fConst1 * fslider4);
		float 	fSlow29 = fslider5;
		float 	fSlow30 = (1 - (1.0f / powf(1e+05f,(1.0f / ((fSlow29 == 0.0f) + (iConst0 * fSlow29))))));
		float 	fSlow31 = fslider6;
		float 	fSlow32 = (fConst3 * fSlow31);
		float 	fSlow33 = (((0.2f * fSlow31) == 0.0f) + fSlow32);
		float 	fSlow34 = (1.0f / (((1.8f * fSlow31) == 0.0f) + (fConst4 * fSlow31)));
		float 	fSlow35 = fslider7;
		float 	fSlow36 = (4.1909515877212175e-10f * fslider8);
		float 	fSlow37 = fslider9;
		float 	fSlow38 = (1 - powf(1e+02f,(1.0f / ((fSlow37 == 0.0f) + (iConst0 * fSlow37)))));
		float 	fSlow39 = fslider10;
		float 	fSlow40 = (1.0f / ((fSlow39 == 0.0f) + (iConst0 * fSlow39)));
		float 	fSlow41 = fslider11;
		float 	fSlow42 = ((0.26f * fslider12) - 0.44f);
		float 	fSlow43 = fslider13;
		float 	fSlow44 = (1.5f * (1.0f - fSlow43));
		int 	iSlow45 = int((int((fConst2 * (fslider14 / fSlow4))) & 4095));
		...
		for (int i=0; i<count; i++) {
			...
			float fTemp0 = ((fConst1 * (fSlow5 + (iSlow3 * fRec5[0]))) + fRec4[1]);
			fRec4[0] = (fTemp0 - floorf(fTemp0));
			iRec6[0] = (iSlow7 & (iRec6[1] | (fRec7[1] >= 1)));
			int iTemp1 = (iSlow8 & (fRec7[1] > 0));
			fRec7[0] = (((iTemp1 == 0) | (fRec7[1] >= 1e-06f)) * ((fSlow12 * (((iRec6[1] == 0) & iSlow7) & (fRec7[1] < 1))) + (fRec7[1] * (1 - (fSlow10 * iTemp1)))));
			fRec8[0] = (fSlow14 + (0.999f * fRec8[1]));
			float fTemp2 = (fRec8[0] * fRec7[0]);
			float fTemp3 = (3.141592653589793f * (fTemp2 * ftbl0[int((65536.0f * fRec4[0]))]));
			float fTemp4 = sinf(fTemp3);
			float fTemp5 = ((fSlow22 * fRec1[(IOTA-iSlow21)&8191]) + (fSlow20 * fRec1[(IOTA-iSlow18)&8191]));
			fVec0[0] = fTemp5;
			float fTemp6 = (0 - fTemp4);
			float fTemp7 = cosf(fTemp3);
			float fTemp8 = ((fVec0[0] * fTemp7) + (fTemp6 * fRec9[1]));
			float fTemp9 = ((fTemp7 * fTemp8) + (fTemp6 * fRec10[1]));
			float fTemp10 = ((fTemp7 * fTemp9) + (fTemp6 * fRec11[1]));
			float fTemp11 = ((fTemp7 * fTemp10) + (fTemp6 * fRec12[1]));
			float fTemp12 = ((fTemp7 * fTemp11) + (fTemp6 * fRec13[1]));
			fRec14[0] = ((fTemp7 * fTemp12) + (fTemp6 * fRec14[1]));
			fRec13[0] = ((fTemp7 * fRec14[1]) + (fTemp4 * fTemp12));
			fRec12[0] = ((fTemp7 * fRec13[1]) + (fTemp4 * fTemp11));
			fRec11[0] = ((fTemp7 * fRec12[1]) + (fTemp4 * fTemp10));
			fRec10[0] = ((fTemp7 * fRec11[1]) + (fTemp4 * fTemp9));
			fRec9[0] = ((fTemp7 * fRec10[1]) + (fTemp4 * fTemp8));
			float fTemp13 = (fTemp2 * (((fSlow26 * (fVec0[0] + fVec0[1])) + (fSlow25 * fVec0[0])) + (fSlow24 * faustpower<2>(fVec0[0]))));
			float fTemp14 = sinf(fTemp13);
			float fTemp15 = (0 - fTemp14);
			float fTemp16 = cosf(fTemp13);
			float fTemp17 = ((fVec0[0] * fTemp16) + (fTemp15 * fRec15[1]));
			...
			fRec2[0] = (0.5f * (((iSlow27 * (((1 - fRec8[0]) * fVec0[0]) + (fRec8[0] * ((fTemp16 * fRec15[1]) + (fVec0[0] * fTemp14))))) + (iSlow23 * ((fTemp7 * fRec9[1]) + (fVec0[0] * fTemp4)))) + fRec2[1]));
			float fTemp22 = (fSlow28 + fRec21[1]);
			fRec21[0] = (fTemp22 - floorf(fTemp22));
			iRec22[0] = (iSlow7 & (iRec22[1] | (fRec24[1] >= 1)));
			iRec23[0] = (iSlow7 * (1 + iRec23[1]));
			int iTemp23 = (iSlow8 & (fRec24[1] > 0));
			fRec24[0] = (((iTemp23 == 0) | (fRec24[1] >= 1e-06f)) * ((fSlow34 * ((1 - (iRec23[1] < fSlow33)) * ((((iRec22[1] == 0) & iSlow7) & (fRec24[1] < 1)) & (iRec23[1] > fSlow32)))) + (fRec24[1] * (1 - (fSlow30 * iTemp23)))));
			iRec25[0] = (12345 + (1103515245 * iRec25[1]));
			iRec26[0] = (iSlow7 & (iRec26[1] | (fRec27[1] >= 1)));
			int iTemp24 = (iSlow8 & (fRec27[1] > 0));
			fRec27[0] = (((iTemp24 == 0) | (fRec27[1] >= 1e-06f)) * ((fSlow40 * (((iRec26[1] == 0) & iSlow7) & (fRec27[1] < 1))) + (fRec27[1] * ((1 - (fSlow38 * (iRec26[1] & (fRec27[1] > 100)))) - (fSlow10 * iTemp24)))));
			float fTemp25 = (fSlow41 * ((fRec27[0] * (0.9f + (fSlow36 * iRec25[0]))) * (1 + (fSlow35 * (fRec24[0] * ftbl0[int((65536.0f * fRec21[0]))])))));
			float fTemp26 = (0 - (fTemp25 + (0.95f * fRec2[0])));
			float fTemp27 = (0.7f + (fSlow42 * fTemp26));
			float fTemp28 = ((fTemp27 * (fTemp27 <= 1)) + (fTemp27 > 1));
			fRec1[IOTA&8191] = (fTemp25 + (fTemp26 * ((fTemp28 * (fTemp28 >= -1)) - (fTemp28 < -1))));
