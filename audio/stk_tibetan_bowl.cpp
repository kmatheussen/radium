...
class Tibetan_Bowl_dsp : public dsp {
  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow39 = (3.141592653589793f * (fSlow38 == 2));
		float 	fSlow40 = (1.5707963267948966f * (fSlow38 == 1));
		float 	fSlow41 = (3.141592653589793f * (fSlow38 == 0));
		float 	fSlow42 = (0.0010000000000000009f * float(fslider3));
		int 	iSlow43 = (fSlow38 < 3);
		float 	fSlow44 = (0.0010000000000000009f * float(fslider4));
		int 	iSlow45 = (fSlow38 != 4);
		float 	fSlow46 = (fSlow10 * (fSlow38 == 4));
		int 	iSlow47 = (fSlow38 >= 3);
		...
		for (int i=0; i<count; i++) {
			...
			fVec11[0] = fTemp5;
			fRec36[0] = (fSlow42 + (0.999f * fRec36[1]));
			float fTemp6 = (fRec36[0] * (((fSlow41 * fVec11[0]) + (fSlow40 * (fVec11[0] + fVec11[1]))) + (fSlow39 * faustpower<2>(fVec11[0]))));
			...
			float fTemp26 = (fRec53[0] * ((iSlow47 * ((fVec11[0] * fTemp18) + (fRec46[1] * fTemp17))) + (iSlow43 * (((1 - fRec36[0]) * fVec11[0]) + (fRec36[0] * ((fVec11[0] * fTemp8) + (fRec37[1] * fTemp7)))))));
