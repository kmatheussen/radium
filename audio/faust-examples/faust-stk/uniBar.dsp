...
[3][unit:s][tooltip:Global envelope attack duration]",0.01,0,2,0.01);
env2Release = hslider("h:Envelopes_and_Vibrato/v:Global_Envelope_Parameters/Glob_Env_Release 
[3][unit:s][tooltip:Global envelope release duration]",0.05,0,2,0.01);
