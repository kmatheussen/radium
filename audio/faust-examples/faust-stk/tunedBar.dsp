...
gain = nentry("h:Basic_Parameters/gain [1][tooltip:Gain (value between 0 and 1)]",0.8,0,1,0.01) : smooth(0.999); 
...
[4][unit:s][tooltip:Global envelope attack duration]",0.02,0,2,0.01);
env2Release = hslider("h:Envelopes_and_Vibrato/v:Global_Envelope_Parameters/Glob_Env_Release 
[4][unit:s][tooltip:Global envelope release duration]",0.1,0,2,0.01);
...
process =
		...
		*(4) : NLFM : *(env2) : stereo ; //: instrReverb;
