...
class System_Eq_dsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addVerticalSlider("Eq1 Freq", &fslider1, 315.0f, 4e+01f, 2e+04f, 1.0f);
		interface->declare(&fslider0, "2", "");
		interface->declare(&fslider0, "style", "knob");
		interface->declare(&fslider0, "tooltip", "Peak level in dB of second-order Regalia-Mitra peaking equalizer section 1");
		interface->declare(&fslider0, "unit", "dB");
		interface->addVerticalSlider("Eq1 Level", &fslider0, 0.0f, -35.0f, 35.0f, 0.1f);
		interface->closeBox();
	}
