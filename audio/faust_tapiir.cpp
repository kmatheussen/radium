...
Compilation options: -a ../Faust_plugins_template.cpp -lang cpp -nvi -ct 1 -cn Tapiir_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class Tapiir_dsp final : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a ../Faust_plugins_template.cpp -lang cpp -nvi -ct 1 -cn Tapiir_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
