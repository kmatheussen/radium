/* ------------------------------------------------------------
name: "system_highshelf"
Code generated with Faust 2.81.2 (https://faust.grame.fr)
Compilation options: -a Faust_plugins_template.cpp -lang cpp -nvi -ct 1 -cn System_Highshelf_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
static float System_Highshelf_dsp_faustpower2_f(float value) {
	return value * value;
}

class System_Highshelf_dsp final : public dsp {
 ...
 public:
	System_Highshelf_dsp() {
	}
	
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a Faust_plugins_template.cpp -lang cpp -nvi -ct 1 -cn System_Highshelf_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "system_highshelf.dsp");
		...
		m->declare("name", "system_highshelf");
	}
	...
	System_Highshelf_dsp* clone() {
		return new System_Highshelf_dsp();
	}
	...
	void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("system_highshelf");
		ui_interface->declare(&fVslider0, "0", "");
		ui_interface->declare(&fVslider0, "unit", "Hz");
		ui_interface->addVerticalSlider("Freq", &fVslider0, FAUSTFLOAT(315.0f), FAUSTFLOAT(4e+01f), FAUSTFLOAT(2e+03f), FAUSTFLOAT(1.0f));
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp0 = System_Highshelf_dsp_faustpower2_f(fRec0[0]);
			fRec1[0] = fSlow1 + 0.999f * fRec1[1];
			float fTemp1 = 1.0f - fRec0[0];
			float fTemp2 = float(input0[i0]);
			fVec0[0] = fTemp2;
			float fTemp3 = fRec0[0] + 1.0f;
			fRec3[0] = -((fTemp1 * fRec3[1] - fRec0[0] * (fTemp2 - fVec0[1])) / fTemp3);
			...
			output0[i0] = FAUSTFLOAT((fTemp0 * fRec1[0] * (fRec2[2] + (fRec2[0] - 2.0f * fRec2[1])) + fRec4[2] + fRec4[0] + 2.0f * fRec4[1]) / fTemp6);
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fVec0[1] = fVec0[0];
			fRec3[1] = fRec3[0];
