...
class Zita_dsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->declare(&fslider0, "tooltip", "Crossover frequency (Hz) separating low and middle frequencies");
		interface->declare(&fslider0, "unit", "Hz");
		interface->addVerticalSlider("LF X", &fslider0, 2e+02f, 5e+01f, 1e+03f, 1.0f);
		interface->declare(&fslider2, "2", "");
		interface->declare(&fslider2, "style", "knob");
		interface->declare(&fslider2, "tooltip", "T60 = time (in seconds) to decay 60dB in low-frequency band");
		interface->declare(&fslider2, "unit", "s");
		interface->addVerticalSlider("Low RT60", &fslider2, 3.0f, 1.0f, 8.0f, 0.1f);
		interface->declare(&fslider1, "3", "");
		interface->declare(&fslider1, "style", "knob");
		interface->declare(&fslider1, "tooltip", "T60 = time (in seconds) to decay 60dB in middle band");
		interface->declare(&fslider1, "unit", "s");
		interface->addVerticalSlider("Mid RT60", &fslider1, 2.0f, 1.0f, 8.0f, 0.1f);
		interface->declare(&fslider3, "4", "");
		interface->declare(&fslider3, "style", "knob");
		interface->declare(&fslider3, "tooltip", "Frequency (Hz) at which the high-frequency T60 is half the middle-band's T60");
		interface->declare(&fslider3, "unit", "Hz");
		interface->addVerticalSlider("HF Damping", &fslider3, 6e+03f, 1.5e+03f, 2.352e+04f, 1.0f);
		interface->closeBox();
		interface->closeBox();
	}
