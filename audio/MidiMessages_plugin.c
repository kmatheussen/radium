...
#define CASE(a,b)                                                       \
    ...
    CASE(GENERAL_PURPOSE_CONTROLLER_1,0x10);
    CASE(GENERAL_PURPOSE_CONTROLLER_2,0x11);
    CASE(GENERAL_PURPOSE_CONTROLLER_3,0x12);
    CASE(GENERAL_PURPOSE_CONTROLLER_4,0x13);
