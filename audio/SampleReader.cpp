...
static float *g_empty_slicebuffer_buffer; __attribute__((constructor)) static void initialize_g_empty_slicebuffer_buffer() { g_empty_slicebuffer_buffer = (float*)V_calloc(sizeof(float), SLICE_SIZE);};
