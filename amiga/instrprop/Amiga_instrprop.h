...
extern int HelpItem149( void );
extern int HelpItem150( void );
extern int HelpItem151( void );
extern int HelpItem152( void );
extern int HelpItem153( void );
extern int HelpItem154( void );
extern int HelpItem155( void );
extern int HelpItem156( void );
extern int HelpItem157( void );
extern int HelpItem158( void );
extern int HelpItem159( void );
extern int HelpItem160( void );
extern int HelpItem161( void );
extern int HelpItem162( void );
extern int HelpItem163( void );
extern int HelpItem164( void );
extern int HelpItem165( void );
extern int HelpItem166( void );

extern int SetupScreen( void );
extern void CloseDownScreen( void );
extern int HandleCPPWindowIDCMP( void );
extern int CPPWindowRawKey();
extern int OpenCPPWindowWindow( void );
extern void CloseCPPWindowWindow( void );
extern int HandleHelpIDCMP( void );
extern int HelpRawKey();
