...
static const char *faust_module_reference =
  ...
  "           N-in/N-out effect. The effect is passed as the SECOND\n"
  "           ARGUMENT, a named effect: process = _,_ :\n"
  "           ef.dryWetMixer(mix, comp); (never ef.dryWetMixer(mix, _)).\n"
  "           FX must have the same number of inputs and outputs\n"
  "           (N-in-N-out).\n"
