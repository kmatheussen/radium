  ...
  */
  ...
  void updateWidgets(){
    ...
    // Audio
    {
      ...
      auto_recording_latency->setText("Soundcard input+output latency reported by driver. (" + QString::number(frames_to_ms(g_jack_system_input_latency + g_jack_system_output_latency), 'f', 2) + "ms)");
