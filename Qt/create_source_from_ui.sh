...
$UIC $UIFILE | sed s/protected/public/ | sed s/QLineEdit/FocusSnifferQLineEdit/ | sed s/QTextEdit/FocusSnifferQTextEdit/ | sed s/QListWidget/FocusSnifferQListWidget/ | sed s/QSpinBox/MyQSpinBox/| sed s/QDoubleSpinBox/FocusSnifferQDoubleSpinBox/ | sed s/QTableWidget/FocusSnifferQTableWidget/ | sed s/\ QSlider/\ MyQSlider/ | sed s/\ QCheckBox/\ MyQCheckBox/ | sed s/\ QToolButton/\ MyQButton/ | sed s:\#include\ \<QtGui/FocusSnifferQLineEdit\>://\ \ qlineedit.h: | sed s:\#include\ \<QtGui/FocusSnifferQTextEdit\>://\ \ qlineedit.h: | sed s:\#include\ \<QtGui/FocusSnifferQListWidget\>://\ \ qlineedit.h: | sed s:\#include\ \<QtGui/MyQSpinBox\>://\ \ qspingox.h:| sed s:\#include\ \<QtGui/FocusSnifferQDoubleSpinBox\>://\ \ qspingox.h: | sed s:\#include\ \<QtGui/FocusSnifferQTableWidget\>://\ \ qspingox.h: >Qt_$3.h
