...
#endif
#include "../bin/packages/QScintilla_gpl-2.10.1/Qt4Qt5/Qsci/qscilexer.h"
#include "../bin/packages/QScintilla_gpl-2.10.1/Qt4Qt5/Qsci/qsciscintilla.h"  // <--- Much trouble. Any qt4 alternatives?
#if __GNUC__ >= 5
