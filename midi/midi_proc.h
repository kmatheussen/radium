...
extern LANGSPEC int MIDI_send_msg_to_patch(struct Patch *patch, void *data, int data_size, int64_t seq_time);
...
extern LANGSPEC int MIDI_get_msg_len(uint32_t msg);
