...
extern LANGSPEC dynvec_t SEQUENCER_TEMPO_get_state(void);

extern LANGSPEC StaticRatio RT_SEQUENCER_SIGNATURE_get_value(double seqtime);
extern LANGSPEC dynvec_t SEQUENCER_SIGNATURE_get_state(void);
...
extern LANGSPEC dynvec_t SEQUENCER_MARKER_get_state(void);
extern LANGSPEC void SEQUENCER_MARKER_create_from_state(dynvec_t markers, double state_samplerate);
