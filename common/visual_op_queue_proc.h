...
extern LANGSPEC void OS_GFX_FilledBox(struct Tracker_Windows* tvisual,enum ColorNums color,int x,int y,int x2,int y2,int where); 
extern LANGSPEC void OS_GFX_Box(struct Tracker_Windows* tvisual,enum ColorNums color,int x,int y,int x2,int y2,int where); 
...
extern LANGSPEC void OS_GFX_Line(struct Tracker_Windows* tvisual,enum ColorNums color,int x,int y,int x2,int y2,int where); 
extern LANGSPEC void OS_GFX_Polygon(struct Tracker_Windows* tvisual,enum ColorNums color,int x1,int y1,int x2,int y2,int num_points,APoint* peaks,int where); 
