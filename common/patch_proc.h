...
extern LANGSPEC void RT_PATCH_send_play_note_to_receivers(struct Patch *patch, int notenum,int velocity,const struct Tracks *track,STime time);
extern LANGSPEC void RT_PATCH_send_stop_note_to_receivers(struct Patch *patch, int notenum,int velocity,const struct Tracks *track,STime time);
extern LANGSPEC void RT_PATCH_send_change_velocity_to_receivers(struct Patch *patch, int notenum,int velocity,const struct Tracks *track,STime time);

extern LANGSPEC void RT_PATCH_play_note(struct Patch *patch,int notenum,int velocity,const struct Tracks *track,STime time);
extern LANGSPEC void RT_PATCH_stop_note(struct Patch *patch,int notenum,int velocity,const struct Tracks *track,STime time);
extern LANGSPEC void RT_PATCH_change_velocity(struct Patch *patch,int notenum,int velocity,const struct Tracks *track,STime time);
extern LANGSPEC void RT_PATCH_change_pitch(struct Patch *patch,int notenum,float pitch,const struct Tracks *track,STime time);

extern LANGSPEC void PATCH_play_note(struct Patch *patch,int notenum,int velocity,const struct Tracks *track);
extern LANGSPEC void PATCH_stop_note(struct Patch *patch,int notenum,int velocity,const struct Tracks *track);
extern LANGSPEC void PATCH_change_velocity(struct Patch *patch,int notenum,int velocity,const struct Tracks *track);
...
extern LANGSPEC int PATCH_get_peaks(struct Patch *patch, int notenum, int ch, const struct Tracks *track, int64_t start_time, int64_t end_time, float *min, float *max);
