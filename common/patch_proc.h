...
extern LANGSPEC void PATCH_remove_from_instrument(struct Patch *patch, bool remove_completely);
...
extern LANGSPEC bool PATCH_make_active_audio(struct Patch *patch, const char *type_name, const char *plugin_name, hash_t *state);
...
extern LANGSPEC struct Patch *PATCH_create_audio(const char *type_name, const char *plugin_name, const char *name, hash_t *state);
...
extern LANGSPEC void RT_PATCH_send_play_note_to_receivers(struct Patch *patch, note_t note,STime time);
extern LANGSPEC void RT_PATCH_send_stop_note_to_receivers(struct Patch *patch, note_t note,STime time);
extern LANGSPEC void RT_PATCH_send_change_velocity_to_receivers(struct Patch *patch, note_t note,STime time);
extern LANGSPEC void RT_PATCH_send_change_pitch_to_receivers(struct Patch *patch, note_t note,STime time);
extern LANGSPEC void RT_PATCH_send_raw_midi_message_to_receivers(struct Patch *patch, uint32_t msg, STime time);

extern LANGSPEC int64_t RT_PATCH_play_note(struct Patch *patch,note_t note,STime time);
extern LANGSPEC void RT_PATCH_stop_note(struct Patch *patch,note_t note,STime time);
extern LANGSPEC void RT_PATCH_change_velocity(struct Patch *patch,note_t note,STime time);
extern LANGSPEC void RT_PATCH_change_pitch(struct Patch *patch,note_t note,STime time);
extern LANGSPEC void RT_PATCH_send_raw_midi_message(struct Patch *patch, uint32_t msg, STime time);

extern LANGSPEC int64_t PATCH_play_note(struct Patch *patch,note_t note);
extern LANGSPEC void PATCH_stop_note(struct Patch *patch,note_t note);
extern LANGSPEC void PATCH_change_velocity(struct Patch *patch,note_t note);
...
extern LANGSPEC void PATCH_change_pitch(struct Patch *patch,note_t note);
