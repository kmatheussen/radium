...
extern LANGSPEC int GFX_Message2_internal(vector_t *buttons, bool program_state_is_valid, const char *fmt,...) __attribute__((format(printf, 3, 4)));
...
extern LANGSPEC void GFX_addMessage_internal(const char *fmt,...) __attribute__((format(printf, 1, 2)));
