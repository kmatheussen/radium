...
#define EVENT_FOCUS_SEQUENCER2 (1<<EVENT_FOCUS_SEQUENCER)
#define EVENT_FOCUS_MIXER2 (1<<EVENT_FOCUS_MIXER)
#define EVENT_FOCUS_MIXERSTRIPS2 (1<<EVENT_FOCUS_MIXERSTRIPS)
#define EVENT_FOCUS_EDITOR2 (1<<EVENT_FOCUS_EDITOR)
