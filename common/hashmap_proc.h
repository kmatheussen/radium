...
extern LANGSPEC const wchar_t *HASH_get_string(hash_t *hash, const char *key);
extern LANGSPEC const char *HASH_get_chars(hash_t *hash, const char *key);
...
extern LANGSPEC const wchar_t *HASH_get_string_at(hash_t *hash, const char *key, int i);
extern LANGSPEC const char *HASH_get_chars_at(hash_t *hash, const char *key, int i);
